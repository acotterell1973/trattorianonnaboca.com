    ...
    dishes: [
        {
            ...
            name: "CALAMARI FRITTI", cost: "$15.00",
        ...
        {
            name: "VONGOLE (IN BIANCO O MARECHIARO)", cost: "$15.00",
        ...
        {
            name: "CAVOLFIORE ALLA SICILIANA", cost: "$13.00",
...
var Insalate_col0 = {
    ...
    dishes: [
        {
            name: "CLASSIC CEASAR", cost: "$12.00",
        ...
        {
            newmenuitem: "New", 
            name: "SICILIAN SALAD", cost: "$15.00",
...
var Insalate_col1 = {
    ...
    dishes: [
...

        {
            ...
            description: "Romaine, red onion, tomatoes, salami, mortadella, aged provolone, kalamata olives, pepperoncini, our balsamic vinaigrette"
        },

        {
            name: "NONNA SALAD", cost: "$10.00",
...
var VITELLO_POLLO_PESCE_col0 = {
    ...
    dishes: [
        ...
        {
            name: "VITELLO SORRENTINA", cost: "$27.00"
        ...
        {
            name: "VITELLO MARSALA", cost: "$27.00"
        ...
        {
            newmenuitem: "New", 
            name: "VITELLO CAPRESE", cost: "$27.00"
        ...
        {
            name: "POLLO GORGONZOLA", cost: "$25.00"
        ...
        {
            name: "POLLO FIORENTINA", cost: "$25.00"
        ...
        {
            name: "POLLO FRANCESE", cost: "$25.00"
        ...
        {
            rightimage: "images/chilipepper.png",
            name: "POLLO SCARPARIELLO", cost: "$28.00"
        ...
        },
        {
            ...
            name: "SHRIMP PARMIGIANA", cost: "$27.00"
...
var VITELLO_POLLO_PESCE_col1 = {
    ...
    dishes: [
        ...
        {
            name: "GAMBERI OREGANATA", cost: "$27.00"
        ...
        {
            name: "SALMONE GENOVESE", cost: "$28.00"
...
var APASTA_col0 = {
    ...
    dishes: [
        {
            name: "RAVIOLI FUNGHI", cost: "$21.00",
...
var GORMET_ARTISIAN_PIZZAS_col1 = {
    categoryName: "GORMET ARTISIAN PIZZAS",
    dishes: [
        {
            name: "CALABRESE", cost: "$15.00 / $20.00",
            imageURL: "images/calabrese-pizza.png",
            description: "Soppresata, provolone cheese, cherry peppers"
        },

        {
            name: "QUATTRO FORMAGGI", cost: "$15.00 / 20.00",
            imageURL: "images/quattro-formaggi.png",
            description: "Fontina, ricotta, mozzarella, provolone, no sauce"
        },

        {
            name: "ARUGULA", cost: "$15.00 / $20.00",
            imageURL: "images/arugula-pizza.png",
            description: "Portobello mushroom, fresh mozzarella, fresh tomatoes, arugula, shaved parmesan, no sauce"
        },

        {
            name: "PESTO", cost: "$15.00 / $20.00",
        ...
        {
            name: "GAMBERETTI SHRIMP SCAMPI", cost: "$16.00 / $21.00",
            imageURL: "images/shrimp-scampi-pizza.png",
            description: "Baby shrimp, garlic, EVOO, basil, mozzarella, no sauce"
        },

        {
            name: "PIZZA DI CAVOLFIORE", cost: "$14.00 / $19.00",
            imageURL: "images/cauliflower-pizza.png",
            description: "Sautéed cauliflower, garlic, oil, mozzarella, bread crumbs, no sauce"
        },

        {
            name: "MALECUMINATA", cost: "$18.00 / $23.00",
            upcharge1: "Add Gluten Free + $5",
            upcharge2: "Add Cauliflower + $5",
...
var CHEF_SPECIALTY_PIZZAS_col1 = {
    categoryName: "CHEF SPECIALTY PIZZAS",
    dishes: [


        {
            name: "MEAT LOVER PIZZA", cost: "$18.00 / $23.00",
            imageURL: "images/meat-lovers-pizza.png",
            description: "Pepperoni, sausage, ham, bacon, meatball"
        },

        {
            name: "HAWAIIAN PIZZA", cost: "$16.00 / $21.00",
...
var CALZONES_col0 = {
    ...
    dishes: [
        ...
        {
            name: "SPINACH CALZON", cost: "$15.00",
            imageURL: "images/9845-calzone.jpg",
...
var ENTREES_AND_APASTA = {
    categoryName: "ENTREES AND A’PASTA",
    dishes: [
        { name: "VEAL MILANESE WITH SALAD", cost: "$12" },

        { name: "VEAL PARGEMIAN WITH PENNE", cost: "$13" },

        { name: "VEAL FRANCESE WITH PENNE", cost: "$13" },

        {
            name: "SPAGHETTI CON POLPETTE", cost: "$10",
            description: "Homemade meatballs with homemade tomato sauce"
        },

        {
            name: "PENNE VODKA SAUCE", cost: "$11",
            description: "Prosciutto, onion with pink sauce"
        },

        { name: "BALES ZITI WITH RICOTTA", cost: "$10" },

        { name: "LINGUINI BOLOGNESE", cost: "$12" },

        { name: "EGGPLANT PARMEGIAN", cost: "$10" },

        { name: "CHICKEN PARMEGIAN WITH PENNE", cost: "$11" },

        { name: "CHICKEN FRANCESE WITH PENNE", cost: "$12" },

        { name: "GRILLED SALMON WITH VEGETABLES", cost: "$15" },
    ]
}
...
var STROMBOLI_col0 = {
    ...
    dishes: [
        { name: "SPINACH",imageURL: "images/9842-stromboli.jpg", cost: "$14.00" },
        { name: "EGGPLANT",imageURL: "images/9842-stromboli.jpg", cost: "$14.00" },
        { name: "CHICKEN PARMIGIANA",imageURL: "images/9842-stromboli.jpg", cost: "$15.00" },
    ]
}
...
var STROMBOLI_col1 = {
    ...
    dishes: [
        ...
        { name: "BROCCOLI – RABE AND SAUSAGE",imageURL: "images/9842-stromboli.jpg", cost: "$15.00" },
...
var html = template(AntiPasti_Col1);
$('#dinner-antipasti-col-1').html(html);

var html = template(Insalate_col0);
$('#dinner-insalate-col-0').html(html);

var html = template(Insalate_col1);
$('#dinner-insalate-col-1').html(html);


var html = template(VITELLO_POLLO_PESCE_col0);
$('#dinner-vitello-pollo-pesce-col-0').html(html);
...
$('#dinner-a-pasta-col-0').html(html);

var html = template(APASTA_col1);
$('#dinner-a-pasta-col-1').html(html);


var html = template(GORMET_ARTISIAN_PIZZAS_col0);
$('#dinner-gourmet-artisan-pizza-col-0').html(html);

var html = template(GORMET_ARTISIAN_PIZZAS_col1);
$('#dinner-gourmet-artisan-pizza-col-1').html(html);



var html = template(CHEF_SPECIALTY_PIZZAS_col0);
$('#dinner-chef-specialty-pizzas-col-0').html(html);

var html = template(CHEF_SPECIALTY_PIZZAS_col1);
$('#dinner-chef-specialty-pizzas-col-1').html(html);


var html = template(CALZONES_col0);
$('#dinner-calzones-col-0').html(html);

var html = template(CALZONES_col1);
$('#dinner-calzones-col-1').html(html);


var html = template(STROMBOLI_col0);
$('#dinner-stromboli-col-0').html(html);

var html = template(STROMBOLI_col1);
$('#dinner-stromboli-col-1').html(html);